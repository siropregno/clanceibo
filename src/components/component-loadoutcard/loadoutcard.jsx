...
const LoadoutCard = ({ branch, role, image, primary, launcher, secondary, specOps, comingSoon, onCopy }) => {
  return (
    <div className={`loadout-card ${comingSoon ? 'coming-soon' : ''}`}>
      {comingSoon && <div className="coming-soon-overlay"><span>Próximamente</span></div>}
      {specOps && <div className="spec-ops-badge">SpecOps</div>}
